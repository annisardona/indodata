...
<section class="login">
	<h1>Login Page</h1>
    <form action="<?php echo site_url('sample_hit/prettyPrint') ?>" method="post">
    
     <p>
        <label for="idPel">ID Pelanggan</label>
        <input type="text" name="idPel" id="idPel" <?php echo $data['trx_id'] ?>>
        
      </p>
	  <p>
        <label for="idPel">ID Pelanggan</label>
        <input type="text" name="idPel" id="idPel" <?php echo $data['subscriber_id'] ?>>
        
      </p>
	  <p>
        <label for="idPel">ID Pelanggan</label>
        <input type="text" name="idPel" id="idPel" <?php echo $data['subscriber_name'] ?>>
